...
VACACIONES = pd.to_datetime([
    '2022-01-01', '2022-02-14', '2022-03-21', '2022-04-10', '2022-04-14', '2022-04-15',
...
def entrenar_modelo_forecasting(df, col, test=False):
    ...
    if test:
        ...
        model.fit(train_df)
        evaluar_modelo_predicciones(model, test_df, col)
    else:
        model.fit(ts)
